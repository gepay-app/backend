 ...
 * {@code throw new ServiceException(IdentityError.USER_NOT_FOUND, userId);} The
 * {@link com.gepe.starter.platform.web.GlobalExceptionHandler} maps the HTTP status from the error code and
